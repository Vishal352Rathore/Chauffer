...
const AllAgent = () => {
        ...
        axios.get(URL ,{ headers: headers })
          .then((result) => {
            ...
            if (result.data.status === true) {
              setAgencyData(result.data.items);
              setFilteredAgency(result.data.items);
    ...
    const handleSearchInputChange = (event) => {
      ...
      if (query.trim() === "") {
        setFilteredAgency(agencyData); // Reset to full list if input field is cleared
        return;
      }
        ...
        <div className="col-md-12">
          <div className="all-driver-header">
            ...
            <div className="add-driver-navigate-btn-div">
              <span>
                <Link to="addAgent  " className="add-driver-btn">
                  {" "}
                  Add Agent
                </Link>{" "}
              </span>
